...
export function Receipt() {
  ...
  if (!order)
    return (
      <div className="p-8 text-center text-stone-500">Carregando recibo...</div>
    );
        ...
        >
          ...
          <div className="bg-gradient-to-r from-rose-500 to-amber-500 p-8 text-white text-center relative">
            ...
            <h1 className="text-3xl font-display font-bold tracking-tight mb-2">
              Comprovante de Pedido de Compra
            </h1>
            <p className="opacity-90 font-medium">
              Este documento detalha o seu orçamento aprovado e formaliza o
              pedido de compra.
            </p>
            ...
            <div className="bg-amber-50 border-y border-amber-200/60 p-6 flex flex-col items-center text-center space-y-4">
              ...
              <div className="max-w-md">
                <h3 className="font-bold text-stone-900 text-sm">
                  Aguardando Pagamento do Sinal / Compra nos EUA
                </h3>
                <p className="text-xs text-stone-600 mt-1 leading-relaxed">
                  Para que nossa especialista <strong>Alê</strong> consiga
                  efetuar a compra física deste produto em Nova York/EUA, é
                  necessário concluir a etapa de pagamento do pedido.
                </p>
              </div>
              ...
              <div className="w-full max-w-sm pt-2 space-y-2">
                ...
                <span className="text-[11px] text-stone-400 block">
                  Seu produto estará aguardando o pagamento de importação em sua
                  sacola.
                </span>
              </div>
            </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="bg-stone-50 p-6 rounded-2xl border border-stone-200/60">
              <h3 className="font-bold text-stone-900 mb-4 border-b border-stone-200 pb-2 flex items-center gap-2">
                <Package className="w-4 h-4 text-rose-500" /> Detalhes dos
                Produtos e Custos
              </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <span className="text-stone-400 block text-xs">
                    Chave Logística de Rastreio
                  </span>
                  <span className="font-mono text-stone-900 px-2 py-0.5 bg-stone-200 rounded text-xs select-all inline-block font-semibold mt-1">
                    {order.trackingId}
                  </span>
                </div>
              </div>
              ...
              {/* Items Table */}
              <div className="mt-6">
                <span className="text-stone-500 block text-xs mb-2">
                  Itens sob Cotação
                </span>
                <ul className="space-y-2.5">
                  {order.items.map((item: any) => (
                    <li
                      key={item.productId}
                      className="flex gap-4 items-center bg-white p-4 rounded-xl border border-stone-200 shadow-sm"
                    >
                      {item.product.imageUrl && (
                        <img
                          ...
                          className="w-12 h-12 rounded-lg object-cover bg-stone-50 border border-stone-100 shrink-0"
                        />
                      )}
                      <div className="flex-grow">
                        <span className="text-sm font-bold text-stone-900 block leading-tight line-clamp-1">
                          {item.product.name}
                        </span>
                        <span className="text-xs text-stone-400 block mt-1 line-clamp-1">
                          {item.product.description}
                        </span>
                      </div>
                      <span className="text-xs font-mono text-stone-500 font-bold bg-stone-150 px-2 py-1 rounded">
                        x{item.quantity}
                      </span>
                    </li>
                  ))}
            ...
            <div className="bg-white border border-stone-200 rounded-xl p-6">
              ...
              <p className="text-xs text-stone-500 mb-4">
                Escaneie para validar o status deste pedido de assessoria de
                compra nos servidores oficiais.
              </p>
          ...
          <div className="bg-stone-900 p-8 text-center text-white">
            <h2 className="text-lg font-display font-bold mb-2">
              Dica by Alê - Assessoria Internacional
            </h2>
            <p className="text-stone-400 text-xs max-w-sm mx-auto">
              Para sua segurança jurídica, seu pedido de compra está respaldado
              pelo CNPJ de intermediação aduaneira nacional.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-stone-200">
        ...
        <div className="bg-emerald-500 p-8 text-white text-center relativereceipt">
          ...
          <h1 className="text-3xl font-display font-bold tracking-tight mb-2">
            Comprovante de Entrega Autêntico
          </h1>
          <p className="opacity-90 font-medium">
            Sua encomenda internacional foi entregue com sucesso.
          </p>
        </div>
        ...
        <div className="p-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-stone-900 font-medium">
                {order.receipt
                  ? new Date(order.receipt.generatedAt).toLocaleString()
          ...
          <div className="bg-stone-50 p-6 rounded-xl border border-stone-100">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <span className="font-mono text-stone-900 px-2 py-1 bg-stone-200 rounded text-sm">
                  {order.trackingId}
                </span>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-2">
                {order.items.map((item: any) => (
                  <li
                    key={item.productId}
                    className="flex justify-between items-center bg-white p-3 rounded-lg border border-stone-200 shadow-sm"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white border border-stone-200 rounded-xl p-6">
            <div>
              ...
              <p className="text-xs text-stone-500 mb-4">
                Escaneie o QR Code para acessar este comprovante e validar sua
            ...
            <div>
              ...
              {order.receipt?.signatureUrl ? (
                <div className="bg-stone-50 rounded-xl border border-stone-200 p-4 flex items-center justify-center">
                  <img
                    src={order.receipt.signatureUrl}
        ...
        <div className="bg-stone-900 p-8 text-center border-t border-stone-100">
          ...
          <p className="text-stone-400 text-sm mb-6 max-w-md mx-auto">
            Esperamos que tenha tido uma excelente experiência importando seus
            produtos. Sua avaliação é muito importante para nós.
          </p>
          <Link
            to={`/rastreio?id=${order.trackingId}`}
            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-xl font-bold transition"
          >
